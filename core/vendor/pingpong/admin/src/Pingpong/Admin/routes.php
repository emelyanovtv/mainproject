...
Route::group(['prefix' => 'admin', 'namespace' => 'Pingpong\Admin\Controllers'], function()
{
	...
	Route::group(['before' => Config::get('admin::filter.auth')], function()
	{
		...
		// settings
		Route::get('admin.operations.showoperations',  ['as' => 'admin.operations.showoperations',  'uses' => 'OperationsController@showoperations']);
        ...
        Route::get('/operations/showoperations/{storage_id?}/{date?}/{material_id?}', 'OperationsController@showoperations');
